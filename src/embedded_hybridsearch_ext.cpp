...
NB_MODULE(embedded_hybridsearch_ext, m) {
    ...
    // hybridsearch
    nb::class_<hybridsearch>(m, "hybridsearch")
        .def(nb::init<>()) // bind constructor

        .def("GetSessionId", &hybridsearch::GetSessionId)

        .def_static("LocalInit", &hybridsearch::LocalInit)
        .def_static("LocalUnInit", &hybridsearch::LocalUnInit)
        .def_static("Hello", &hybridsearch::Hello)

        .def_static("RemoteConnect", &hybridsearch::RemoteConnect)
        .def("RemoteDisconnect", &hybridsearch::RemoteDisconnect)
        .def_static("LocalConnect", &hybridsearch::LocalConnect)
        .def("LocalDisconnect", &hybridsearch::LocalDisconnect)
        ...
        .def("SetVariableOrConfig", nb::overload_cast<hybridsearch &, const String &, bool, SetScope>(&WrapSetVariableOrConfig))
        .def("SetVariableOrConfig", nb::overload_cast<hybridsearch &, const String &, i64, SetScope>(&WrapSetVariableOrConfig))
        .def("SetVariableOrConfig", nb::overload_cast<hybridsearch &, const String &, double, SetScope>(&WrapSetVariableOrConfig))
        .def("SetVariableOrConfig", nb::overload_cast<hybridsearch &, const String &, String, SetScope>(&WrapSetVariableOrConfig))
