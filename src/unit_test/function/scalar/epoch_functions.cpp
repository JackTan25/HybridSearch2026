...
TEST_P(EpochFunctionsTest, epoch_func) {
...

    {
        ...
        EXPECT_STREQ("epoch(Date)->BigInt", func.ToString().c_str());
        ...
        ScalarFunction func = scalar_function_set->GetMostMatchFunction(inputs);
        EXPECT_STREQ("epoch(DateTime)->BigInt", func.ToString().c_str());
...

    {
        ...
        ScalarFunction func = scalar_function_set->GetMostMatchFunction(inputs);
        EXPECT_STREQ("epoch(Timestamp)->BigInt", func.ToString().c_str());
