...
class WeekOfYearFunctionsTest : public BaseTestParamStr {};

INSTANTIATE_TEST_SUITE_P(TestWithDifferentParams, WeekOfYearFunctionsTest, ::testing::Values(BaseTestParamStr::NULL_CONFIG_PATH));

TEST_P(WeekOfYearFunctionsTest, week_of_year_func) {
    using namespace hybridsearch;
...

    {
        ...
        EXPECT_STREQ("weekofyear(Date)->BigInt", func.ToString().c_str());
        ...
        ScalarFunction func = scalar_function_set->GetMostMatchFunction(inputs);
        EXPECT_STREQ("weekofyear(DateTime)->BigInt", func.ToString().c_str());
...

    {
        ...
        ScalarFunction func = scalar_function_set->GetMostMatchFunction(inputs);
        EXPECT_STREQ("weekofyear(Timestamp)->BigInt", func.ToString().c_str());
