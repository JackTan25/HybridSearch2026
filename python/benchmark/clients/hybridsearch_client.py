...
class hybridsearchClient(BaseClient):
    def __init__(self, conf_path: str) -> None:
        ...
        self.client = hybridsearch.connect(NetworkAddress(host, int(port)))
    ...
    def upload(self):
        ...
        #inf_http_client = hybridsearchHttpClient("default_db", self.table_name)
        inf_http_client = hybridsearch_http()
    ...
    def setup_clients(self, num_threads=1):
        ...
        for i in range(num_threads):
            client = hybridsearch.connect(NetworkAddress(host, int(port)))
    ...
    def do_single_query(self, query_id, client_id) -> list[Any]:
        ...
        if self.data_mode == "vector":
            ...
            query_builder = hybridsearchThriftQueryBuilder(table_obj)
