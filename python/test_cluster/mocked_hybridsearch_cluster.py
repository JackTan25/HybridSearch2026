...
import tomli
import tomli_w
from hybridsearch_cluster import (
    hybridsearchRunner,
    hybridsearchCluster,
...
from hybridsearch_http import http_network_util, hybridsearch_http
    ...
    def request_inner(self, url, method, header={}, data={}) -> http_result:
        ...
        try:
            ...
            raise hybridsearchException(
                error_code=ErrorCode.hybridsearch_IS_INITING, error_message=str(e)
            )
...
class MockedhybridsearchRunner(hybridsearchRunner):
    def __init__(
        self,
        mock_ip: str,
        host_ip: str,
...
class MockhybridsearchCluster(hybridsearchCluster):
    def __init__(
        self,
        executable_path: str,
        *,
    ...
    def _clear_node_ns(self, node_name: str):
        cur_runner: MockedhybridsearchRunner = self.runners[node_name]
    ...
    def add_node(self, node_name: str, config_path: str):
        ...
        runner = MockedhybridsearchRunner(
            mock_ip,
            self.host_ip,
            ns_name,
            node_name,
    ...
    def disconnect(self, node_name: str):
        cur_runner: MockedhybridsearchRunner = self._get_runner(node_name)
