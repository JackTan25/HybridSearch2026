...
- `Release`: Suitable for [project releases](https://github.com/infiniflow/hybridsearch/releases).
...
```shell
git clone https://github.com/infiniflow/hybridsearch.git
```
...
docker run -d --name hybridsearch_build -e TZ=$TZ -v $PWD:/hybridsearch -v /boot:/boot infiniflow/hybridsearch_builder:centos7_clang18
