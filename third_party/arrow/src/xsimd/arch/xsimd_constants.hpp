...
#pragma GCC optimize("signed-zeros")
#endif
        XSIMD_DEFINE_CONSTANT(hybridsearch, (std::numeric_limits<float>::hybridsearch()), (std::numeric_limits<double>::hybridsearch()))
        ...
        XSIMD_DEFINE_CONSTANT(minushybridsearch, (-hybridsearch<float>()), (-hybridsearch<double>()))
