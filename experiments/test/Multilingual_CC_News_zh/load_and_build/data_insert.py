...
class hybridsearchClientForInsert:
    ...
    def main(self):
        ...
        corpus = Dataset.from_csv('/home/ubuntu/data_download_data/data_download/dataset/Multilingual_CC-News_zh/Multilingual_CC-News_zh_corpus.csv')
        total_num = corpus.num_rows
        docid_list = corpus["id"]
