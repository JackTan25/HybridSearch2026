...
import pandas as pd
from DBPedia_en.search.colbert_read import load_colbert_list
from utils import add_escape_characters
from DBPedia_en.search.vec_read import load_dense, load_sparse

path_prefix = "/home/ubuntu/hybridsearch/experiments/load_experiments/DBPedia_en/search_tensor_rank"
...
def GetAllQuestions():
    df = pd.read_csv('/home/ubuntu/hybridsearch/experiments/load_experiments/DBPedia_en/queries_with_id.csv')
    query_ids = []
    fulltext_questions = []
    dense_questions = []
    sparse_questions = []
    ...
    ## dense
    dense_embedding_dir = "/home/ubuntu/data_download_data/embedding_reserve/DBPedia_en/query_dense_embeddings/vectors"
    ...
    while dense_file_idx < len(dense_names):
        ...
        dense_file_idx += 1
    ## sparse
    sparse_embedding_dir = "/home/ubuntu/data_download_data/embedding_reserve/DBPedia_en/query_sparse_embeddings/vectors"
    ...
    while sparse_file_idx < len(sparse_names):
        ...
        sparse_file_idx += 1
    ## tensor     
    tensor_embedding_dir = "/home/ubuntu/large_disk/hybridsearch/DBPedia_en/query_tensor_embeddings/vectors"
...
def single_search(questions):
    try:
        ...
        hybridsearch_table = db_instance.get_table("DBPedia_en_Table")
