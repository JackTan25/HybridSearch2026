...
table = db_instance.get_table('MLDR_zh_Table')
table.drop_index('MLDR_zh_tensor_index')
print(db_instance.show_table('MLDR_zh_Table'))
# print(db_instance.drop_table('MLDR_zh_Table6'))
# corpus = pd.read_csv('/home/ubuntu/data_download_data/embedding_reserve/MLDR_zh/english/MLDR_zh_combine_corpus.csv')
