...
path_prefix = "/home/ubuntu/infinity/experiments/load_experiments/MLDR_zh/search_tensor_rank"
...
def GetAllQuestions():
    df = pd.read_csv('/home/ubuntu/infinity/experiments/load_experiments/MLDR_zh/queries_with_id.csv')
    query_ids = []
    fulltext_questions = []
    dense_questions = []
    sparse_questions = []
...
def single_search(questions):
    try:
        ...
        infinity_table = db_instance.get_table("MLDR_zh_Table")
