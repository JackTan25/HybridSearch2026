import os
import time
from FiQA_2018_en.search.vec_read import load_sparse
...
table = db_instance.get_table('FiQA_2018_en_Table')
table.drop_index('FiQA_2018_en_tensor_index')
print(db_instance.show_table('FiQA_2018_en_Table'))
# print(db_instance.drop_table('FiQA_2018_en_Table6'))
# corpus = pd.read_csv('/home/ubuntu/data_download_data/embedding_reserve/FiQA-2018_en/english/FiQA_2018_en_combine_corpus.csv')
...
dense_embedding_dir = '/home/ubuntu/data_download_data/embedding_reserve/FiQA-2018_en/dense_embeddings/vectors'

sparse_embedding_dir = '/home/ubuntu/data_download_data/embedding_reserve/FiQA-2018_en/sparse_embeddings/vectors'
