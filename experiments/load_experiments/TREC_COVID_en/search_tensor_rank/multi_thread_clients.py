...
from TREC_COVID_en.search_tensor_rank.two_roads.dense_fulltext_search import fulltext_dense_search
from TREC_COVID_en.search_tensor_rank.two_roads.dense_fulltext_search import GetQuestions as GetDenseFulltextQuestions
from TREC_COVID_en.search_tensor_rank.two_roads.sparse_fulltext_search import fulltext_sparse_search 
from TREC_COVID_en.search_tensor_rank.two_roads.sparse_fulltext_search import GetQuestions as GetSparseFulltextQuestions
from TREC_COVID_en.search_tensor_rank.two_roads.sparse_dense_search import dense_sparse_search
from TREC_COVID_en.search_tensor_rank.two_roads.sparse_dense_search import GetQuestions as GetSparseDenseQuestions

from TREC_COVID_en.search_tensor_rank.three_roads.sparse_dense_fulltext_search import fulltext_dense_sparse_search
from TREC_COVID_en.search_tensor_rank.three_roads.sparse_dense_fulltext_search import GetQuestions as GetSparseDenseFulltextQuestions
...
def main():
    global process_func
    with open("/home/ubuntu/hybridsearch/experiments/load_experiments/TREC_COVID_en/search_tensor_rank/multi_thread_result.txt",'w') as multi_thread_file:
