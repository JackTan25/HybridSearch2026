...
path_prefix = "/home/ubuntu/hybridsearch/experiments/load_experiments/TREC_COVID_en/search_tensor_rank"
...
def GetAllQuestions():
    ...
    ## dense
    dense_embedding_dir = "/home/ubuntu/data_download_data/embedding_reserve/TREC-COVID_en/query_dense_embeddings/vectors"
    ...
    while dense_file_idx < len(dense_names):
        ...
        dense_file_idx += 1
    ## sparse
    sparse_embedding_dir = "/home/ubuntu/data_download_data/embedding_reserve/TREC-COVID_en/query_sparse_embeddings/vectors"
    ...
    while sparse_file_idx < len(sparse_names):
        ...
        sparse_file_idx += 1
    ## tensor     
    tensor_embedding_dir = "/home/ubuntu/data_download_data/embedding_reserve/TREC-COVID_en/query_tensor_embeddings/vectors"
