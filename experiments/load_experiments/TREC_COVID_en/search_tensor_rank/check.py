import os
import time
from TREC_COVID_en.search.vec_read import load_sparse
...
table.drop_index('TREC_COVID_en_tensor_index')
...
dense_embedding_dir = '/home/ubuntu/data_download_data/embedding_reserve/TREC-COVID_en/dense_embeddings/vectors'

sparse_embedding_dir = '/home/ubuntu/data_download_data/embedding_reserve/TREC-COVID_en/sparse_embeddings/vectors'
