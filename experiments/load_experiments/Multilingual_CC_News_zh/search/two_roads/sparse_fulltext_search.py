...
path_prefix = "/home/ubuntu/hybridsearch/experiments/load_experiments/Multilingual_CC_News_zh/search"
...
def GetQuestions():
    ...
    for i in range(len(query_ids)):
        questions.append((fulltext_questions[i],sparse_questions[i],query_ids[i]))
    print(len(questions))
    return questions
