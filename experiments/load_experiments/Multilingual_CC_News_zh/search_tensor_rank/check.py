...
table = db_instance.get_table('Multilingual_CC_News_zh_Table')
table.drop_index('Multilingual_CC_News_zh_tensor_index')
print(db_instance.show_table('Multilingual_CC_News_zh_Table'))
# print(db_instance.drop_table('Multilingual_CC_News_zh_Table6'))
# corpus = pd.read_csv('/home/ubuntu/data_download_data/embedding_reserve/Multilingual_CC_News_zh/english/Multilingual_CC_News_zh_combine_corpus.csv')
