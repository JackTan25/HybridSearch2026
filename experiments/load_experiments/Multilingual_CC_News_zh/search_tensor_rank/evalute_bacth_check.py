...
qrel_file_path = "/home/ubuntu/hybridsearch/experiments/load_experiments/Multilingual_CC_News_zh/qrels/dev.tsv"
# query_result_file_path = "/home/ubuntu/hybridsearch/experiments/load_experiments/Multilingual_CC_News_zh/Multilingual_CC_News_zh.search_tensor_rank1000/four_roads/fulltext_dense_sparse_tensor_result.txt"
...
def load_qrel_map():
    ...
    df = pd.read_csv(qrel_file_path, sep=' ',names=column_names,header=None,skiprows=1)
