...
qrel_file_path = "/home/ubuntu/data_download_data/embedding_reserve/Touche_2020_en/english/qrels/test.tsv"
query_result_file_path = "/home/ubuntu/hybridsearch/experiments/load_experiments/Touche_2020_en/Touche_2020_en.search_tensor_rank/three_roads/fulltext_dense_sparse_result.txt"
...
def main():
    ...
    for query_id, corpus_id_list in result.items():
        ...
        idcg = calculate_dcg(sorted(scores_list, reverse=True), 10)
