...
import pandas as pd
from Touche_2020_en.search.colbert_read import load_colbert_list
from utils import add_escape_characters
from Touche_2020_en.search.vec_read import load_dense, load_sparse

path_prefix = "/home/ubuntu/hybridsearch/experiments/load_experiments/Touche_2020_en/search_tensor_rank"
...
def GetAllQuestions():
    ...
    ## dense
    dense_embedding_dir = "/home/ubuntu/data_download_data/embedding_reserve/Touche_2020_en/query_dense_embeddings/vectors"
    ...
    while sparse_file_idx < len(sparse_names):
        ...
        sparse_file_idx += 1
    ## tensor     
    tensor_embedding_dir = "/home/ubuntu/data_download_data/embedding_reserve/Touche_2020_en/query_tensor_embeddings/vectors"
