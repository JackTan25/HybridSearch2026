...
table = db_instance.get_table('Touche_2020_en_Table')
table.drop_index('Touche_2020_en_tensor_index')
print(db_instance.show_table('Touche_2020_en_Table'))
# print(db_instance.drop_table('Touche_2020_en_Table6'))
# corpus = pd.read_csv('/home/ubuntu/data_download_data/embedding_reserve/Touche_2020_en/english/Touche_2020_en_combine_corpus.csv')
...
dense_embedding_dir = '/home/ubuntu/data_download_data/embedding_reserve/Touche_2020_en/dense_embeddings/vectors'

sparse_embedding_dir = '/home/ubuntu/data_download_data/embedding_reserve/Touche_2020_en/sparse_embeddings/vectors'
