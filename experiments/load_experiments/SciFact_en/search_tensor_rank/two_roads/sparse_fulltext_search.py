...
path_prefix = "/home/ubuntu/hybridsearch/experiments/load_experiments/SciFact_en/search_tensor_rank"
...
def GetAllQuestions():
    df = pd.read_csv('/home/ubuntu/hybridsearch/experiments/load_experiments/SciFact_en/queries_with_id.csv')
    query_ids = []
    fulltext_questions = []
    dense_questions = []
    sparse_questions = []
...
def single_search(questions):
    try:
        ...
        hybridsearch_table = db_instance.get_table("SciFact_en_Table")
