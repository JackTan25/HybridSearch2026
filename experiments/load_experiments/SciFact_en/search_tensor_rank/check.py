import os
import time
from SciFact_en.search.vec_read import load_sparse
...
table = db_instance.get_table('SciFact_en_Table')
table.drop_index('SciFact_en_tensor_index')
print(db_instance.show_table('SciFact_en_Table'))
# print(db_instance.drop_table('SciFact_en_Table6'))
# corpus = pd.read_csv('/home/ubuntu/data_download_data/embedding_reserve/SciFact_en/english/SciFact_en_combine_corpus.csv')
...
dense_embedding_dir = '/home/ubuntu/data_download_data/embedding_reserve/SciFact_en/dense_embeddings/vectors'

sparse_embedding_dir = '/home/ubuntu/data_download_data/embedding_reserve/SciFact_en/sparse_embeddings/vectors'
