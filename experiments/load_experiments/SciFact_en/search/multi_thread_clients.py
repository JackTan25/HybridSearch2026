...
from SciFact_en.search.single_road.dense_search import dense_search
from SciFact_en.search.single_road.dense_search import GetQuestions as GetDenseQuestions
from SciFact_en.search.single_road.fulltext_search import fulltext_search
from SciFact_en.search.single_road.fulltext_search import GetQuestions as GetFulltextQuestions
from SciFact_en.search.single_road.sparse_search import sparse_search
from SciFact_en.search.single_road.sparse_search import GetQuestions as GetSparseQuestions

from SciFact_en.search.two_roads.dense_fulltext_search import fulltext_dense_search
from SciFact_en.search.two_roads.dense_fulltext_search import GetQuestions as GetDenseFulltextQuestions
from SciFact_en.search.two_roads.sparse_fulltext_search import fulltext_sparse_search 
from SciFact_en.search.two_roads.sparse_fulltext_search import GetQuestions as GetSparseFulltextQuestions
from SciFact_en.search.two_roads.sparse_dense_search import dense_sparse_search
from SciFact_en.search.two_roads.sparse_dense_search import GetQuestions as GetSparseDenseQuestions

from SciFact_en.search.three_roads.dense_fulltext_sparse import fulltext_dense_sparse_search
from SciFact_en.search.three_roads.dense_fulltext_sparse import GetQuestions as GetSparseDenseFulltextQuestions
...
def main():
    global process_func
    with open("/home/ubuntu/hybridsearch/experiments/load_experiments/SciFact_en/search/multi_thread_result.txt",'w') as multi_thread_file:
