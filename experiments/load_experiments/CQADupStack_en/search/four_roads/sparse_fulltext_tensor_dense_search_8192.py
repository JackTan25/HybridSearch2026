...
def fulltext_dense_sparse_tensor_search(infinity_table, question):
     ...
     res = (
                ...
                .match_dense("dense_col", question[1], "float", "ip", 10)
                .match_sparse("sparse_col", question[2], "ip", 10)
                .match_tensor("tensor_col", question[3], "float", 10, {
                                "emvb_centroid_nprobe":"2",
                                "emvb_threshold_first":"0.3",
                                "emvb_threshold_final":"0.4"
                })
...
def single_search(questions):
    try:
        ...
        with open(path_prefix + '/four_roads/fulltext_dense_sparse_tensor_8192_result.txt','w') as result_file:
            id = 0
            time_cost = 0
