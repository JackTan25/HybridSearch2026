...
from search_weigthed_sum1000.two_roads.dense_fulltext_search import fulltext_dense_search
from search_weigthed_sum1000.two_roads.dense_fulltext_search import GetQuestions as GetDenseFulltextQuestions
from search_weigthed_sum1000.two_roads.sparse_fulltext_search import fulltext_sparse_search 
from search_weigthed_sum1000.two_roads.sparse_fulltext_search import GetQuestions as GetSparseFulltextQuestions
from search_weigthed_sum1000.two_roads.sparse_dense_search import dense_sparse_search
from search_weigthed_sum1000.two_roads.sparse_dense_search import GetQuestions as GetSparseDenseQuestions

from search_weigthed_sum1000.three_roads.sparse_dense_fulltext_search import fulltext_dense_sparse_search
from search_weigthed_sum1000.three_roads.sparse_dense_fulltext_search import GetQuestions as GetSparseDenseFulltextQuestions
...
def main():
    global process_func
    with open("/home/ubuntu/hybridsearch/experiments/load_experiments/CQADupStack_en/search_weigthed_sum1000/multi_thread_result.txt",'w') as multi_thread_file:
