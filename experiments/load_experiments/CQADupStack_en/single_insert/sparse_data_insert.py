...
class hybridsearchClientForInsert:
    def __init__(self):
        ...
        self.test_table_name_prefix = "CQADupStack_en_Table_sparse"
    ...
    def main(self):
        ...
        while sparse_file_idx < len(sparse_names) :
            ...
            while sparse_idx < len(sparse_vectors) :
                ...
                insert_dict = {
                                ...
                                "sparse_col": SparseVector(indices,values),
                            }
                doc_id_idx += 1
                dense_idx += 1
                sparse_idx += 1
        ...
        with open('/home/ubuntu/hybridsearch/experiments/load_experiments/CQADupStack_en/single_insert/sparse_insert_time.txt', 'w') as f:
