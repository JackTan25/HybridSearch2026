...
class hybridsearchClientForInsert:
    def __init__(self):
        ...
        self.test_table_name_prefix = "CQADupStack_en_Table_fulltext_sparse"
        self.test_table_schema = {
                                    "docid_col": {"type": "varchar"}, 
                                    "fulltext_col": {"type": "varchar"},
                                }
    ...
    def main(self):
        ...
        while dense_file_idx < len(dense_names) :
            ...
            while dense_idx < len(dense_vectors) :
                ...
                insert_dict = {
                                ...
                                "fulltext_col": corpus_text_list[doc_id_idx],
                            }
                doc_id_idx += 1
                dense_idx += 1
                sparse_idx += 1
        ...
        with open('/home/ubuntu/hybridsearch/experiments/load_experiments/CQADupStack_en/single_insert/fulltext_insert_time.txt', 'w') as f:
