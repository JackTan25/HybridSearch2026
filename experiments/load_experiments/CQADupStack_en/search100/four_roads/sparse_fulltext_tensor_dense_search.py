...
path_prefix = "/home/ubuntu/infinity/experiments/load_experiments/CQADupStack_en/search100"
...
def fulltext_dense_sparse_tensor_search(infinity_table, question):
     ...
     res = (
                ...
                .match_dense("dense_col", question[1], "float", "ip", 100)
                .match_sparse("sparse_col", question[2], "ip", 100)
                .match_tensor("tensor_col", question[3], "float", 100)
