...
# query_result_file_path = "/home/ubuntu/hybridsearch/experiments/load_experiments/MLDR_en/search_tensor_rank10001000/four_roads/fulltext_dense_sparse_tensor_result.txt"
...
post_file_paths = [
    ...
    ## two_roads
    "two_roads/dense_sparse_result.txt","two_roads/fulltext_sparse_result.txt",
    # "two_roads/sparse_tensor_result.txt",
    "two_roads/fulltext_dense_result.txt",
    # "two_roads/dense_tensor_result.txt","two_roads/fulltext_tensor_result.txt",
    ## three_roads 
    "three_roads/fulltext_dense_sparse_result.txt",
    # "three_roads/dense_sparse_tensor_result.txt","three_roads/fulltext_sparse_tensor_result.txt","three_roads/fulltext_dense_tensor_result.txt", 
    ## four_roads
