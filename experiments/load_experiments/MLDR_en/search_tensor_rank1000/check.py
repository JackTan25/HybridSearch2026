import os
import time
from MLDR_en.search.vec_read import load_sparse
...
table = db_instance.get_table('MLDR_en_Table')
table.drop_index('MLDR_en_tensor_index')
print(db_instance.show_table('MLDR_en_Table'))
# print(db_instance.drop_table('MLDR_en_Table6'))
# corpus = pd.read_csv('/home/ubuntu/data_download_data/embedding_reserve/mldr_en/english/MLDR_en_combine_corpus.csv')
...
sparse_embedding_dir = '/home/ubuntu/data_download_data/embedding_reserve/mldr_en/sparse_embeddings/vectors'
