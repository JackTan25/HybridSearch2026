...
def fulltext_dense_sparse_search(hybridsearch_table, question):
     ...
     res = (
                ...
                .match_dense("dense_col", question[1], "float", "ip", 1000,{"ef": "600"})
                .match_sparse("sparse_col", question[2], "ip", 1000)
                # .match_tensor("tensor_col", question[2], "float", 1000)
...
def single_search(questions):
    ...
    try:
        ...
        with open(path_prefix + '/three_roads/fulltext_dense_sparse_result2.txt','w') as result_file:
            id = 0
            time_cost = 0
