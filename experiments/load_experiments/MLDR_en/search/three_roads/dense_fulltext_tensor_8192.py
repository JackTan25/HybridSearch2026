...
path_prefix = "/home/ubuntu/infinity/experiments/load_experiments/MLDR_en/search"
...
cost_time = 0
def fulltext_dense_tensor_search(infinity_table, question):
     global cost_time
    ...
    try:
        ...
        with open(path_prefix + '/three_roads/fulltext_dense_tensor_result_8192.txt','w') as result_file:
            ...
            for question in questions:
                id += 1
                begin_time = time.time()
                qb_result, extra_result = fulltext_dense_tensor_search(infinity_table, question)
                end_time = time.time()
