...
query_result_file_path = "/home/ubuntu/hybridsearch/experiments/load_experiments/MLDR_en/search/two_roads/result/sparse_tensor_result.txt"
...
def main():
    ...
    for query_id, corpus_id_list in result.items():
        ...
        # scores_list = [qrel_mapping[corpus_id] for corpus_id in corpus_id_list if corpus_id in qrel_mapping]
