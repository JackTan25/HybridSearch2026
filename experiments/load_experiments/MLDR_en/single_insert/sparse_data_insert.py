...
class InfinityClientForInsert:
    def __init__(self):
        ...
        self.test_table_name_prefix = "mldr_en_Table_sparse"
    ...
    def main(self):
        ...
        with open('/home/ubuntu/infinity/experiments/load_experiments/MLDR_en/single_insert/sparse_insert_time.txt', 'w') as f:
