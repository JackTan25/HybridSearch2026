...
class hybridsearchClientForInsert:
    def __init__(self):
        ...
        self.test_table_name_prefix = "mldr_en_Table_dense"
    ...
    def main(self):
        ...
        with open('/home/ubuntu/hybridsearch/experiments/load_experiments/MLDR_en/single_insert/dense_insert_time.txt', 'w') as f:
